...
namespace Blackfinch.StockTradingPlatform.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "Blackfinch Stock Trading Platform", Version = "v1"});
            });
            ...
            //Demo data load
            services.AddHostedService<InitiallyDataImportService>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c =>
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Blackfinch Stock Trading Platform v1"));
            }
